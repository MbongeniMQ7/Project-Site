        ...
        <div className="container pb-8 sm:pb-0">
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            <div className="flex flex-col justify-center gap-6 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1">
              ...
              >
                Start your wonderful day with a cup from {" "}
                <span
                  data-aos="zoom-out"
                  data-aos-delay="300"
              ...
              <div data-aos="fade-up" data-aos-delay="400">
                <button className="bg-gradient-to-r from-primary to-secondary border-2 border-primary hover:scale-105 duration-200 text-white py-2 px-4 rounded-full">
                  You cant be patrolling Gauteng Maboneng without our cup
                </button>
              </div>
            </div>
            {/* Image section */}
            ...
            >
              ...
              >
                <h1 className="text-white">“In Coffee We Trust,
                     Bean There, Sipped That. Java Nice Day!”</h1>
              </div>
              <div
                data-aos="fade-right"
                data-aos-offset="0"
              ...
              >
                <h1 className="text-white">Catch some Java then script some java</h1>
              </div>
            </div>
          </div>
        </div>
